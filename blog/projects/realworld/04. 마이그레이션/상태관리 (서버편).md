...
- 학습 목적에서 두 가지 서비스에만 Tanstack Query를 적용해보고 비교해보자. 또한 전역에서 관리한 게 아까우니까 <mark>헤더의 사용자 이름 옆에, 프로필의 배너에 팔로워 수</mark>를 추가적으로 띄워보자. 이러면 Tanstack Query를 사용하는게 의미가 있으니까.  
## 4. 설정 방법  
### tanstack query  
